      ...
      <v-list>
        ...
        <v-list-item link to="/streams" style="height: 59px">
          ...
          <v-list-item-content>
            ...
            <v-list-item-subtitle class="caption">All your orders.</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>

        <v-list-item link to="/nested-batch" style="height: 59px">
          <v-list-item-icon>
            <v-icon>mdi-folder</v-icon>
          </v-list-item-icon>
          <v-list-item-content>
            <v-list-item-title class>Nested Batch</v-list-item-title>
            <v-list-item-subtitle class="caption">Selected nested batches</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>
